"""
Django settings for giturdone project.
...
SECRET_KEY = '+6c+8tl67n)2_-)cx9xc)!*olfxi^pae0^#1v3kg-shwh9!+=@'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'giturdone_quiz.processors.custom_processor',
...
WSGI_APPLICATION = 'giturdone.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'giturdone.sqlite3'),
    }
}
